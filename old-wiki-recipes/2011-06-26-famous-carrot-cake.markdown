...
---
(:if false:)
Summary:this is the world-famous carrot cake recipe, a true favourite
Parent:(Recipes.)Desserts
Tags:dessert, recipes, carrot cake
(:tags-hide dessert, recipes, carrot cake:)
Categories:[[!Recipes]],[[!Dessert]],[[!BakedGoods]]
Source:
(:ifend:)
...
Doing most of the prep work in a food processor makes this an easy recipe. I remember grating carrots as a kid and getting my hands all bloody in the process. Still, I did it gratefully ''(pi)'' and would do it again if I didn't have a handy food processor.
...
# Pour batter into an '''un'''greased 9x13 pan and spread evenly
...
* 2 tsps vanilla
* 1/4 cup butter
* 1/2 cup raisins ''(the page I'm copying from says these are optional, I say they are mandatory!)''
